...
//        currentUserModel.setUsername(newUsername);
        ...
        {
            firebase.getCurrentProfilePicStorageRef().putFile(selectedImageUri)
...
//        }
    ...
    void updateToFirestore(){
        firebase.currentuserdetails().set(currentUserModel)
                .addOnCompleteListener(task -> {
                    setInProgress(false);
    ...
    void getUserData(){
        ...
        firebase.getCurrentProfilePicStorageRef().getDownloadUrl()
                        .addOnCompleteListener(task -> {
                            if(task.isSuccessful()){
